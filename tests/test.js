...
// PR - start of change
// PR: Added the following 2 rows because the following definition didn't work when "expect" was part of the const definition
// const { GET, POST, DELETE, PATCH, expect } = cds.test(__dirname + '../../')
// ... I don't really know why and what exactly I'm doing here :-(
